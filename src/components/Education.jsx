  ...
  return (
    <motion.div
      ...
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-gray-400 max-w-2xl mx-auto mb-16">A brief overview of my educational background and academic journey.</p>
          ...
          <div className="space-y-12">
            {
              studyData.map((data, index) => (
                <div key={index} className="relative pl-12
                       before:content-[''] before:absolute before:left-0 before:top-0 before:w-[2px] before:h-full before:bg-purple
